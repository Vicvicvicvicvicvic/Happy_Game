...
class MainActivity : AppCompatActivity() {
    ...
    var candies = intArrayOf(
        R.drawable.purple_candy,
        R.drawable.green_candy,
        R.drawable.pink_candy,
        R.drawable.yellow_candy,
        R.drawable.dount,
        R.drawable.lolipop,
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for(imagineView in candy){
            imagineView.setOnTouchListener(object : OnSwipeListener(this){
                override fun onSwipeRight() {
                    super.onSwipeRight()
                    candyToBeDragged = imagineView.id
                ...
                override fun onSwipeTop() {
                    super.onSwipeTop()
                    candyToBeDragged = imagineView.id
                    candyToReplaced = candyToBeDragged - noOfBlock
                    candyInterChacge()
                }
    ...
    private fun starRepeat() {
        repeatChecker.run()
    }


    private fun candyInterChacge() {
        var background:Int = candy.get(candyToReplaced).tag as Int
    ...
    private fun moveDownCandies() {
        var firstRow = arrayOf(1, 2, 3, 4, 5, 6, 7)
        var list = asList(*firstRow)
